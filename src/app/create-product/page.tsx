  ...
  return (
    <div className=" m-8">
      <div className="flex gap-1">
        ...
        <p className="text-gray-400 font-medium">your own product</p>
      </div>
      ...
      <div className="flex relative gap-5 mb-4">
          <input
            type="name"
            id="name"
            name="name"
          ...
          />
            <div className="">
          <button className="flex mx-auto text-white bg-gray-500 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-lg">Select</button>
        </div>
        </div>
      </div>
      <div className="">
